...
def reponse(request, pk):
    ...
    return render(request, 'forumestc/reponses.html',
                  {'reponses': reponses, 'sujetc': sujetc, 'dpt': dpt, 'sujet_id': sujet_id})
...
def administrateur(request):
    if request.user.is_superuser or request.user.is_staff:
        ...
        return render(request, 'forumestc/administrateur.html',
                      {'titre': titre, 'sujets': sujets, 'reponses': reponses})
    else:
        return redirect('forumestc:forum_home')
